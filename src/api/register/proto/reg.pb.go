...
type In struct {
	...
	Pwds  string `protobuf:"bytes,3,opt,name=pwds,proto3" json:"pwds,omitempty"`
...
var file_reg_proto_rawDesc = []byte{
	,
	...
	0x73, 0x61, 0x67, 0x65, 0x22, 0x1c, 0x0a, 0x04, 0x44, 0x61, 0x74, 0x61, 0x12, 0x14, 0x0a, 0x05,
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x32, 0x2e, 0x0a, 0x08, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65, 0x72, 0x12, 0x22,
	0x0a, 0x04, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x03, 0x2e, 0x49, 0x6e, 0x1a, 0x04, 0x2e, 0x4f, 0x75,
	0x74, 0x22, 0x0f, 0x82, 0xd3, 0xe4, 0x93, 0x02, 0x09, 0x22, 0x04, 0x2f, 0x72, 0x65, 0x67, 0x3a,
...
var file_reg_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_reg_proto_depIdxs = []int32{
	...
	0, // 1: Register.Call:input_type -> In
	1, // 2: Register.Call:output_type -> Out
...
// RegisterClient is the client API for Register handle.
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
type RegisterClient interface {
	Call(ctx context.Context, in *In, opts ...grpc.CallOption) (*Out, error)
}
...
func (c *registerClient) Call(ctx context.Context, in *In, opts ...grpc.CallOption) (*Out, error) {
	out := new(Out)
	err := c.cc.Invoke(ctx, "/Register/Call", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// RegisterServer is the server API for Register handle.
type RegisterServer interface {
	Call(context.Context, *In) (*Out, error)
}
...
func (*UnimplementedRegisterServer) Call(context.Context, *In) (*Out, error) {
...
func _Register_Call_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(In)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegisterServer).Call(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Register/Call",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegisterServer).Call(ctx, req.(*In))
	}
...
var _Register_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Call",
			Handler:    _Register_Call_Handler,
		},
	},
